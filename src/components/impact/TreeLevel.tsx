...
const TreeLevel = ({ level, label, target, current, onAchieve }: TreeLevelProps) => {
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-3">
          ...
          {/* Level name */}
          <div>
            <span className={`text-sm font-semibold ${achieved ? "text-green-400" : "text-foreground"}`}>
              {label}
            </span>
        ...
        <div className="flex items-center gap-2">
          <TreePine className={`w-4 h-4 ${achieved ? "text-green-400" : "text-muted-foreground"}`} />
          <span className={`text-sm font-bold ${achieved ? "text-green-400" : "text-foreground"}`}>
