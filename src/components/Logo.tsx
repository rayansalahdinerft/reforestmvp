import logoAsset from "@/assets/reforest-logo.png.asset.json";

const Logo = () => {
  return (
    <div className="flex items-center gap-1.5 cursor-pointer">
      <img src={logoAsset.url} alt="ReforestWallet logo" className="w-9 h-9 md:w-[46px] md:h-[46px] rounded-xl" />
