  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          'fixed bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] md:bottom-6 right-3 md:right-6 z-[55] w-11 h-11 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg transition-all duration-300',
